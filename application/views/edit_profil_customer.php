...
.uploadbtn:hover span {
  ...
  transform: translateY(300%);
			...
			<div class="register" pull-left" style="width:100%;">
		  	  <form method="POST" action="<?=base_url();?>welcome/post">
				 <div class="register-top-grid">
					<h3>PERSONAL INFORMATION</h3>
					<div class="mation">
						<span>Nama<label>*</label></span>
						<input type="text" name="nama" value="<?=$customer['nama'];?>" required>
                  		<input type="hidden" class="form-control" required name="id_customer" value="<?=$customer['id_customer'];?>"> 					
						...
						<input type="email" name="email" class="form-control" value="<?=$customer['email'];?>" required> 
						 ...
						 <input type="text" name="no_tlp" class="form-control" value="<?=$customer['no_tlp'];?>" required>
    ...
    $('#upload').trigger('click');
				     ...
				     <div class="register-bottom-grid">
							...
							<div class="mation">
								...
								<input type="password" placeholder="Password" id="password" name="password" class="form-control" value="<?=$customer['password'];?>" required >
								<span>Confirm Password<label>*</label></span>
								<input type="password" placeholder="Confirm Password" id="confirm_password" class="form-control" value="<?=$customer['password'];?>" required>
							</div>
					 </div>
				<div class="clearfix"> </div>
